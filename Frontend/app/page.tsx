          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mt-1 flex items-center gap-2">
                ...
                Advanced Mortgage Intelligence •{" "}
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-gray-400 mt-1">
                    Analyzing mortgage data • Powered by LN AI
                  </span>
                </div>
              </motion.div>
            )}
            ...
            {messages.length === 1 &&
              ...
              !loading && (
                <div className="flex flex-wrap gap-3 mt-4 animate-fade-in-slow">
                  {[
                    {
                      text: "Check best rates across all lenders",
                      icon: TrendingUp,
                    },
                    {
                      text: "Calculate eligibility for ₹1 Cr loan",
                      icon: Calculator,
                    },
                    {
                      text: "Compare banks for 600 CIBIL score",
                      icon: FileText,
                    },
                  ].map((item, idx) => (
                    <motion.button
